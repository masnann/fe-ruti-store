...
const GetAllArticle = () => {
  ...
  const handleReadMore = (articleId) => {
    // Navigasi ke halaman detail dengan ID artikel
  ...
  return (
    <div className="bg-gray-100 p-4">
      {articles.map((article) => (
        <div
          key={article.id}
          className="flex flex-col items-center sm:flex-row sm:justify-start mb-8 bg-white rounded-lg shadow-lg p-4 lg:p-8"
        >
